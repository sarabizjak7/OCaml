...
(*
   Denimo, da moramo vrniti število n, for each bill, let s_b denote the recursively computed shortest list to change n-bill.
   Take the shortest s_b and add its corresponding bill b to it to change the amount n.
*)
